...
CATEGORIES_DATA = {
    ...
    "Operazioni": {
        ...
        "responses": [
            ...
            {"text": "Parametri di funzionamento: velocita (default 50%), potenza (default 75%), tempo ciclo variabile in base al materiale", "keywords": "velocita, potenza, parametri, ciclo"},
            ...
            {"text": "Per regolare la velocita di lavoro: utilizzare il potenziometro sul pannello di controllo, non superare il 90% per materiali delicati", "keywords": "velocita, potenziometro, regolazione, materiali delicati"},
        ],
    },
}
