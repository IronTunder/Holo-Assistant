...
SETTINGS: tuple[SettingDefinition, ...] = (
    ...
    SettingDefinition("DATABASE_NAME", "Database", "Nome database", "Nome del database applicativo.", "string", "holo_assistant_db", True),
    ...
    SettingDefinition("HOLO_ASSISTANT_CACHE_ENABLED", "Cache", "Cache abilitata", "Abilita le cache in memoria del backend.", "boolean", "true"),
    SettingDefinition("HOLO_ASSISTANT_CACHE_TOTAL_MAX_BYTES", "Cache", "Limite totale cache", "Budget massimo in byte per le cache.", "integer", "134217728", True, 1048576),
    SettingDefinition("HOLO_ASSISTANT_RETRIEVAL_CACHE_TTL_SECONDS", "Cache", "TTL retrieval", "Durata in secondi della cache retrieval.", "integer", "600", True, 0),
    SettingDefinition("HOLO_ASSISTANT_RETRIEVAL_CACHE_MAX_ENTRIES", "Cache", "Voci retrieval", "Numero massimo di risultati retrieval in cache.", "integer", "512", True, 0),
    SettingDefinition("HOLO_ASSISTANT_TTS_CACHE_TTL_SECONDS", "Cache", "TTL TTS", "Durata in secondi della cache audio TTS.", "integer", "1800", True, 0),
    SettingDefinition("HOLO_ASSISTANT_TTS_CACHE_MAX_BYTES", "Cache", "Limite cache TTS", "Budget massimo in byte per la cache TTS.", "integer", "67108864", True, 1048576),
    SettingDefinition("HOLO_ASSISTANT_TTS_CACHE_MAX_TEXT_CHARS", "Cache", "Testo cacheabile TTS", "Lunghezza massima testo per caching TTS.", "integer", "500", True, 1, 2000),
    SettingDefinition("HOLO_ASSISTANT_TTS_CACHE_MAX_AUDIO_BYTES", "Cache", "Audio cacheabile TTS", "Dimensione massima audio TTS cacheabile.", "integer", "2097152", True, 1024),
    SettingDefinition("HOLO_ASSISTANT_ADMIN_METADATA_CACHE_TTL_SECONDS", "Cache", "TTL metadata admin", "Durata in secondi della cache metadata admin.", "integer", "10", True, 0),
