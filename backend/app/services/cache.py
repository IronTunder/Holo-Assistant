...
CACHE_ENABLED = _env_bool("DITTO_CACHE_ENABLED", True)
TOTAL_CACHE_MAX_BYTES = _env_int("DITTO_CACHE_TOTAL_MAX_BYTES", 134_217_728)
RETRIEVAL_CACHE_TTL_SECONDS = _env_int("DITTO_RETRIEVAL_CACHE_TTL_SECONDS", 600)
RETRIEVAL_CACHE_MAX_ENTRIES = _env_int("DITTO_RETRIEVAL_CACHE_MAX_ENTRIES", 512)
TTS_CACHE_TTL_SECONDS = _env_int("DITTO_TTS_CACHE_TTL_SECONDS", 1800)
TTS_CACHE_MAX_BYTES = _env_int("DITTO_TTS_CACHE_MAX_BYTES", 67_108_864)
TTS_CACHE_MAX_TEXT_CHARS = _env_int("DITTO_TTS_CACHE_MAX_TEXT_CHARS", 500)
TTS_CACHE_MAX_AUDIO_BYTES = _env_int("DITTO_TTS_CACHE_MAX_AUDIO_BYTES", 2_097_152)
ADMIN_METADATA_CACHE_TTL_SECONDS = _env_int("DITTO_ADMIN_METADATA_CACHE_TTL_SECONDS", 10)
