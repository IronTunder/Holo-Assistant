...
VOICE_KEY="${HOLO_ASSISTANT_PIPER_DEFAULT_VOICE_KEY}"
VOICE_MODEL_FILENAME="${HOLO_ASSISTANT_PIPER_DEFAULT_VOICE_MODEL_FILENAME}"
VOICE_CONFIG_FILENAME="${HOLO_ASSISTANT_PIPER_DEFAULT_VOICE_CONFIG_FILENAME}"
