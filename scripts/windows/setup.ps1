...
try {
    ...
    Write-Host "========================================"
    Write-Host ""
    Write-Host "Accesso dal computer locale:"
    Write-Host "   - Frontend: https://localhost:$DittoDefaultFrontendPort"
    Write-Host "   - Backend API: https://localhost:$DittoDefaultBackendPort"
    Write-Host "   - Documentazione API: https://localhost:$DittoDefaultBackendPort/docs"
    Write-Host "   - Adminer DB: http://localhost:8080"
    Write-Host ""
    Write-Host "Accesso da altri dispositivi (stessa rete):"
    Write-Host "   - Frontend: https://$ip`:$DittoDefaultFrontendPort"
